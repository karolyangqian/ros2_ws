...
: ${AMENT_CURRENT_PREFIX:="/home/karol/ITB/URO/KRAI/ros2_ws/install/package1"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/package1/environment/pythonpath.sh"
