...
bool package1__srv__add_two_ints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("package1.srv._add_two_ints.AddTwoInts_Request", full_classname_dest, 45) == 0);
  }
  package1__srv__AddTwoInts_Request * ros_message = _ros_message;
  {  // a
...
PyObject * package1__srv__add_two_ints__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("package1.srv._add_two_ints");
...
ROSIDL_GENERATOR_C_EXPORT
bool package1__srv__add_two_ints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("package1.srv._add_two_ints.AddTwoInts_Response", full_classname_dest, 46) == 0);
  }
  package1__srv__AddTwoInts_Response * ros_message = _ros_message;
  {  // sum
